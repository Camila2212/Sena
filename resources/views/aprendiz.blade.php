...
<body>
    ...
    <script>
      var res=function(){
        var not=confirm("¿Estas seguro de eliminar este aprendiz");
        return not;
      }
    </script>

    <!-- Modal Registar Aprendiz-->
    <div class="modal fade" id="modalInsertar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo Aprendiz</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                data-bs-target="#modalModificar{{ $item->idAprendiz }}"><i class="fa-solid fa-user-pen"></i></a>
                            <a href="{{route('aprendiz.delete', $item->idAprendiz)}}" onclick="return res()" class="btn btn-danger btn-sm"><i class="fa-solid fa-user-minus"></i></a>
                        </td>
